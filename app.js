...
;
  ...
  angular.module('myApp').controller('SpellsController', function($scope) {
    ...
    $scope.spellsMasterList = [
      ...
      { id:140, name:'', ring:'void', type:'', level:'1', range:'', area_of_affect:'', duration:'', raises:'', get roll() { return spellRoll(this); }, description:' Pg 185 Core Book' },
    ];
